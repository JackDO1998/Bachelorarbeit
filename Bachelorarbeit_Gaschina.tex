...
% Kopfnoten
\ihead{\href{https://www.tu-dortmund.de/}{\includegraphics[height=25pt]{TUlogo.png}}}  % links
\ohead{\href{https://physik.tu-dortmund.de/}{\includegraphics[height=25pt]{FAKlogo.png}}}  % rechts
...
\usepackage{xcolor}
\definecolor{TU}{rgb}{0.4,0.8,0.2}
\addtokomafont{disposition}{\color{TU}}
