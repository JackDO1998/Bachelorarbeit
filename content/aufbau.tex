...
im Sommer 2022 umgebaut um mittels einem \glqq echo-enabled harmonic generation\grqq  oder kurz EEHG 
...
Abtastrate von $\SI{5}{\giga\sample\per\second}$ verwendet. 
